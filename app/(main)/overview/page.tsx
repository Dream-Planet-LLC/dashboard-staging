...
const Overview = () => {
  ...
  // Table Columns
  // ────────────────────────────────────────────────
  const columns: ColumnDef<LatestProduct>[] = [
    {
      accessorKey: "name",
      header: "Product Name",
      cell: ({ row }) => {
        ...
        return (
          <div className="flex items-center gap-3">
            ...
            <span className="font-medium text-[#373737] INT500 text-[14px] leading-[20px] tracking-[-1.5%]">
              {row.getValue("name") || 'Unknown Product'}
            </span>
          </div>
        );
      },
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div>
       ...
       Monitor your Marketplace Performance and Manage Creator Stores
        </p>
      </div>
